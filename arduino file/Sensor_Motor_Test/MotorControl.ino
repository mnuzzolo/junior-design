...
void pivot_left_forward(int time){
  digitalWrite(6, HIGH);//enable driver 1 on
  analogWrite(9, 90);//disable driver 2 
  digitalWrite(4, LOW); //right wheel reverse 
  digitalWrite(10, HIGH);
  digitalWrite(7, LOW ); //left wheel forward
  digitalWrite(8, HIGH);  
  delay(time);
}

void pivot_left_backward(int time){
  digitalWrite(6, HIGH);//enable driver 1 on
  analogWrite(9, 90);//disable driver 2 
  digitalWrite(4, HIGH); //right wheel reverse 
  digitalWrite(10, LOW);
  digitalWrite(7, HIGH); //left wheel backward
  digitalWrite(8, LOW);  
  delay(time);
}
...
void pivot_right_backward(int time){
  digitalWrite(6, LOW);//diable driver 1 
  digitalWrite(9, HIGH);//enable driver 2 
  digitalWrite(4, LOW); //right wheel reverse 
  digitalWrite(10, HIGH);
